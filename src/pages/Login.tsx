...
export default function LoginPage() {
  ...
  return (
    <div className="space-y-8 text-slate-900">
      <div>
        <p className="text-sm uppercase tracking-[0.24em] text-brand-600">CareLink access</p>
        <h1 className="mt-4 text-3xl font-semibold">Login to your account</h1>
        <p className="mt-2 text-sm text-slate-500">Search and request appointments with healthcare professionals.</p>
      </div>
      ...
      <p className="text-center text-sm text-slate-500">
        New user? <Link to="/auth/register" className="font-semibold text-brand-600 hover:text-brand-700">Create an account</Link>
      </p>
    </div>
  );
}
