    ...
    <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-soft">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-brand-600">Verificato {profile.role === 'association' ? 'Associazione' : 'Professionista'}</p>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-3xl bg-blueglass p-4 text-center">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-500">Valutazione</p>
          ...
          <div className="rounded-3xl bg-blueglass p-4 text-center">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-500">Recensioni</p>
            <p className="mt-2 text-2xl font-semibold text-slate-900">{profile.reviews_count}</p>
          </div>
          <div className="rounded-3xl bg-blueglass p-4 text-center">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-500">Certificato</p>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        <span className="inline-flex items-center gap-2 rounded-full bg-brand-50 px-4 py-2 text-sm text-brand-700">
          <ShieldCheck className="h-4 w-4" /> Profilo verificato
        </span>
